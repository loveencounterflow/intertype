(function() {
  'use strict';
  var E, Intertype, WG, _Intertype, built_ins, create, debug, default_declarations, hide, internal_declarations, internal_types, isa, nameit, rpr, types, validate;
