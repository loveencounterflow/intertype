(function() {
  'use strict';
  var E, Intertype, Intertype_minimal, WG, _TMP_basetype_names, _TMP_basetype_names_matcher, _isa, basetypes, debug, default_declarations, default_types, hide, nameit, rpr, set, types;
