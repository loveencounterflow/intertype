(function() {
  'use strict';
  var CND, E, GUY, H, HEDGES, ITYP, Intertype_abc, alert, badge, debug, echo, help, info, log, njs_path, praise, rpr, types, urge, warn, whisper, x,
    splice = [].splice;
  ...
  this.Intertype = (function() {
    class Intertype extends Intertype_abc {
      ...
      constructor(cfg) {
        ...
        GUY.props.hide(this, 'declare', new Proxy(this._declare, {
          get: (_, type) => {
            return (cfg) => {
              return this._declare(type, cfg);
            };
          }
        }));
      ...
      _declare(type, type_cfg) {
        var group, hedge, hedgepath, i, j, len, len1, ref, ref1, self;
        type_cfg = {
          ...type_cfg,
          name: type
        };
