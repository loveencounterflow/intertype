(function() {
  'use strict';
  var CND, E, GUY, H, HEDGES, ITYP, Intertype_abc, alert, badge, debug, echo, help, info, log, njs_path, praise, ref, rpr, types, urge, warn, whisper, x,
    ...
    class Intertype extends Intertype_abc {
      ...
      constructor(cfg) {
        ...
        for (group of ref1) {
          ...
          ((group) => {
            return GUY.props.hide(this.isa, group, (x) => {
              var R;
              R = this.groups[group].has(this.type_of(x));
              return this._protocol_isa(group, R, R);
            });
          })(group);
        }
        ...
        this.declare('object', {
          test: function(x) {
            return (H.type_of(x)) === 'object';
          }
        });
        this.declare('float', {
          groups: 'number',
          test: function(x) {
            return (H.type_of(x)) === 'float';
          }
        });
        this.declare('text', {
          groups: 'collection',
          test: function(x) {
            return (H.type_of(x)) === 'text';
          }
        });
        //.......................................................................................................
        return void 0;
      ...
      declare(type, type_cfg) {
        ...
        for (i = 0, len = ref1.length; i < len; i++) {
          ...
          for (hedgepath of ref2) {
            ...
            //...................................................................................................
            ((hedgepath) => {
              return GUY.props.hide(self, type, (x) => {
      ...
      _isa(...hedges) {
        var R, e, hedge, hedge_idx, i, len, ref1, tail_hedges, type, typetest, verdict, x;
        boundMethodCheck(this, ref);
...
// debug '^3324^', { tail_hedges, }
      ...
      _test_hedge(hedge, x) {
        ...
        switch (R = hedgetest(x)) {
          case H.signals.true_and_break:
            return this._protocol_isa(hedge, R, R);
          case H.signals.false_and_break:
            return this._protocol_isa(hedge, R, R);
          case false:
            return this._protocol_isa(hedge, R, false);
