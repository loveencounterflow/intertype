(function() {
  'use strict';
  var CND, Multimix, alert, assign, badge, cast, check, debug, declarations, flatten, get_rprs_of_tprs, help, info, isa, isa_list_of, jk_equals, jr, js_type_of, rpr, sad, urge, validate, validate_list_of, warn, whisper, xrpr;
