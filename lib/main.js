(function() {
  ...
  /* TAINT make sure no non-numbers slip through */  default_declarations = {
    ...
    float: {
      test: _isa.float,
      create: function(x) {
        if (x === false || x === null || x === (void 0) || x === 0 || x === '0') {
          return 0;
        }
        if (x === true || x === '1') {
          return 1;
    ...
    _declare(cfg, ...declarations) {
      ...
      for (i = 0, len = declarations.length; i < len; i++) {
        ...
        for (type in collection) {
          ...
          ((type, test) => {
            var declaration, field_name, fq_type_name, prefix, ref1, ref2, ref3, results, sub_type, target_type, targets;
            //...................................................................................................
            ...
            results = [];
            for (prefix of ref2) {
              if (/quantity|foo|mass|zap/.test(type)) {
                ...
                debug('Ωit___2', {
                  ...
                  create: (ref3 = this.create[type]) != null ? ref3 : null
                });
              }
              // target_for_create_method          = get_from_dotted_name @create, prefix
              set_dotted_name(this.create, prefix, this.create[type]);
...
//.....................................................................................................
    ...
    _get_declaration_template(type, cfg = null, kind = null) {
      kind = _isa.text(kind) ? kind : 'unknown';
      return {
        type,
        kind,
        ...cfg,
    ...
    _compile_declaration_object(cfg, type, declaration) {
      ...
      var R, kind, ref1, ref2;
      kind = _isa.text(declaration) ? declaration : (ref1 = declaration.test) != null ? ref1 : null;
      R = this._get_declaration_template(type, cfg, kind);
      ...
      if (R.kind !== 'unknown') {
        if (R.create == null) {
          R.create = (ref2 = this.create[R.kind]) != null ? ref2 : null;
        }
      }
      //.......................................................................................................
    ...
    _get_create(declaration) {
      ...
      switch (true) {
        case create != null:
          ...
          return nameit(`create.${type}`, function(...P) {
            var R, evaluation;
  ...
  //===========================================================================================================
  get_from_dotted_name = function(x, dotted_name) {
    var R, i, len, part, ref1;
    R = x;
    ref1 = dotted_name.split('.');
  ...
  //-----------------------------------------------------------------------------------------------------------
  set_dotted_name = function(x, dotted_name, value) {
    var i, last_part, len, part, parts, ref1, target;
    ref1 = dotted_name.split('.'), [...parts] = ref1, [last_part] = splice.call(parts, -1);
    target = x;
