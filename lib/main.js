  ...
  Intertype = class Intertype {
      ...
      for (i = 0, len = declarations.length; i < len; i++) {
        ...
        for (type in collection) {
          ...
          ((type, test) => {
            ...
            this.validate[type] = this._get_validate(type, declaration.test);
            this.validate.optional[type] = this._get_validate_optional(type, declaration.test);
    ...
    _compile_declaration_object(type, declaration) {
      ...
      switch (true) {
        ...
        default:
          //.....................................................................................................
          throw new E.Intertype_wrong_type('^constructor@5^', "type name, test method, or object", this.__type_of(_isa, R.test));
      }
      //.......................................................................................................
    ...
    _validate_test_method(type, x) {
      if (!_isa.function(x)) {
        throw new E.Intertype_test_must_be_function('^constructor@6^', type, this.__type_of(_isa, x));
      }
      if (x.length !== 1) {
