(function() {
  'use strict';
  var E, Intertype, Intertype_minimal, WG, _Intertype, built_ins, create, debug, default_declarations, hide, internal_declarations, internal_types, isa, nameit, rpr, type_of, types, validate;
          ...
          for (type in collection) {
            ...
            ((type, test) => {
              ...
              if (collection !== built_ins) {
                return this._tests_for_type_of[type] = declaration.test;
              }
            })(type, test);
          }
        }
