(function() {
  'use strict';
  var E, Intertype, Intertype_minimal, WG, _isa, built_ins, debug, default_declarations, hide, internal_declarations, nameit, rpr, set, types;
  ...
  Intertype = class Intertype {
      ...
      for (i = 0, len = declarations.length; i < len; i++) {
        ...
        for (type in collection) {
          ...
          ((type, test) => {
            ...
            this.isa.optional[type] = this.get_isa_optional(declaration);
    ...
    _compile_declaration_object(type, declaration) {
      ...
      * return `R`
      ...
      switch (true) {
        ...
        default:
          //.....................................................................................................
          throw new E.Intertype_wrong_type('^constructor@1^', "type name, test method, or object", this.__type_of(_isa, declaration));
      }
    ...
    _validate_test_method(type, x) {
      if (!_isa.function(x)) {
        throw new E.Intertype_test_must_be_function('^constructor@2^', type, this.__type_of(_isa, x));
      }
      if (!_isa.unary(x)) {
    ...
    get_isa_optional(declaration) {
      var me;
      me = this;
      return nameit(`isa.optional.${declaration.type}`, function(x) {
        var field_name, ref1, sub_test;
        if (arguments.length !== 1) {
