(function() {
  'use strict';
  var E, Intertype, Intertype_minimal, WG, _isa, built_ins, debug, default_declarations, default_types, hide, nameit, rpr, set, types;
...
//.....................................................................................................
    ...
    _compile_declaration_object(type, declaration) {
      ...
      switch (true) {
        ...
        case _isa.text(R.test):
          ((ref_type) => {
            var is_optional, ref_declaration;
            ...
            ((test) => {
              if (is_optional) {
                R.test = nameit(type, function(x)/* debug '^879-1^', is_optional, type, test, x; */ {
                  if (x == null) {
                    return true;
                  }
                ...
                R.test = nameit(type, function(x)/* debug '^879-2^', is_optional, type, test, x; */ {
                  return test.call(this, x);
                });
              }
              return null;
    ...
    _get_isa(declaration) {
      ...
      if (declaration.is_optional) {
        //.......................................................................................................
        return nameit(`isa.${type}`, this._get_isa_optional(declaration));
      }
      return nameit(`isa.${type}`, function(x) {
        ...
        for (field_name in sub_tests) {
          ...
          if (!default_types.has(declaration.type)) {
    ...
    _get_validate(declaration) {
      ...
      if (declaration.is_optional) {
        //.......................................................................................................
        return nameit(`validate.${type}`, this._get_validate_optional(declaration));
      }
