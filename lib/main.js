...
(function() {
  'use strict';
  var CND, Multimix, alert, assign, badge, debug, declarations, flatten, help, info, isa, jr, js_type_of, rpr, urge, validate, warn, whisper, xrpr;
  ...
  isa = function(type, ...xP) {
    ...
    return this._check_spec(false, type, ...xP);
  };
  ...
  validate = function(type, ...xP) {
    ...
    return this._check_spec(true, type, ...xP);
  };
