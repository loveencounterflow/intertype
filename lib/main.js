(function() {
  'use strict';
  var CND, Defaults, E, Empty, GUY, Intertype_abc, Isa, Isa_empty, Isa_list_of, Isa_nonempty, Isa_optional, List_of, Nonempty, Validate, Validate_empty, Validate_list_of, Validate_nonempty, Validate_optional, alert, badge, debug, echo, empty, error, help, info, js_type_of, length_of, list_of, log, njs_path, nonempty, praise, ref, rpr, urge, warn, whisper, x,
  ...
  ref = this.Intertype = (function() {
    class Intertype extends Intertype_abc {
      ...
      declare(...hedges) {
        ...
        var defaults, descriptor, mandatory_empty_name, mandatory_empty_test, mandatory_name, mandatory_nonempty_name, mandatory_nonempty_test, mandatory_test, optional_empty_name, optional_empty_test, optional_name, optional_nonempty_name, optional_nonempty_test, optional_test, ref1, test, type;
        boundMethodCheck(this, ref);
        ref1 = hedges, [...hedges] = ref1, [type, descriptor] = splice.call(hedges, -2);
        defaults = {
          numeric: false,
          collection: false
        };
        descriptor = {...defaults, ...descriptor};
        if (descriptor.collection && (descriptor.size == null)) {
        ...
        mandatory_test = descriptor.test.bind(this);
        ...
        if (descriptor.collection) {
          ...
          mandatory_empty_test = (test = function(x) {
            return (mandatory_test(x)) && (this._is_empty(descriptor, x));
          }).bind(this);
          ...
          mandatory_nonempty_test = (test = function(x) {
            return (mandatory_test(x)) && (this._is_nonempty(descriptor, x));
          }).bind(this);
      ...
      //---------------------------------------------------------------------------------------------------------
      _is_empty(descriptor, x) {
        return (this._size_of(descriptor, x)) === 0;
      }

      _is_nonempty(descriptor, x) {
        return (this._size_of(descriptor, x)) > 0;
      }
