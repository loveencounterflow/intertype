(function() {
  ...
  Intertype = class Intertype {
    ...
    _declare(...declarations) {
      ...
      // debug '^998-4^', @isa.optional.quantity, @isa.optional.quantity { q: 3, u: 'g', } if ( type is 'quantity' ) or ( target_type is 'quantity' )
      // debug '^998-5^', @isa.optional.quantity, @isa.optional.quantity null if ( type is 'quantity' ) or ( target_type is 'quantity' )
      //.......................................................................................................
      return null;
    }
...
//.....................................................................................................
    ...
    _get_isa(declaration) {
      ...
      me = this;
      // debug '^998-6^', "create isa          method for", { type } unless _TMP_isa_minimal_type type
      //.......................................................................................................
      return nameit(`isa.${type}`, function(x) {
        var field_name, sub_test;
        // debug '^998-7^', "isa", { type, x } #, me.isa[ type ]
    ...
    _get_isa_optional(declaration) {
      ...
      ({type, test, sub_tests} = declaration);
      me = this;
      // debug '^998-8^', "create isa.optional method for", { type } unless _TMP_isa_minimal_type type
      //.......................................................................................................
      return nameit(`isa.optional.${type}`, function(x) {
        var field_name, sub_test;
        // debug '^998-9^', "isa.optional", { type, x } #, me.isa[ type ]
        if (arguments.length !== 1) {
