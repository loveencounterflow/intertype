(function() {
  'use strict';
  var E, Intertype, Intertype_minimal, WG, _TMP_builtin_typenames, _TMP_builtin_typenames_matcher, _isa, built_ins, debug, default_declarations, default_types, hide, nameit, rpr, set, types;
  ...
  _TMP_builtin_typenames_matcher = RegExp(`\\b(${[..._TMP_builtin_typenames].join('|')})\\b`);

  //-----------------------------------------------------------------------------------------------------------
  default_declarations = _isa = {
    basetype: function(x) {
      return _TMP_builtin_typenames.has(x);
    },
    boolean: function(x) {
...
//.....................................................................................................
      ...
      switch (true) {
        ...
        case _isa.text(R.test):
          ((ref_type) => {
            ...
            if ((basetype = this._extract_first_builtin_typename(ref_type)) != null) {
              throw new E.Intertype_illegal_use_of_basetype('^_resolve_dotted_type@3^', type, basetype);
            }
        ...
        default:
          //.....................................................................................................
          throw new E.Intertype_wrong_type('^_compile_declaration_object@3^', "type name, test method, or object", this.__type_of(_isa, R.test));
      }
      //.......................................................................................................
    ...
    _extract_first_builtin_typename(type) {
      var match;
      if (!_isa.text(type)) {
        throw new E.Intertype_internal_error('^_extract_first_builtin_typename@1^', `expected text, got a ${this.__type_of(_isa, type)}`);
      }
      if ((match = type.match(_TMP_builtin_typenames_matcher)) == null) {
        return null;
      }
      return match[0];
    }
