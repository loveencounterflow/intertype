(function() {
  'use strict';
  var E, Intertype, Intertype_minimal, WG, _TMP_basetype_names, _TMP_basetype_names_matcher, _TMP_isa_minimal_type/* TAINT unfortunate choice of name */, _TMP_minimal_types, __type_of, _isa, basetypes, debug, deepmerge, default_declarations, default_types, hide, nameit, rpr, set, types, walk_transitive_field_names;
    ...
    _declare(...declarations) {
      ...
      for (i = 0, len = declarations.length; i < len; i++) {
        ...
        for (type in collection) {
          ...
          ((type, test) => {
            var declaration, field_name, fq_type_name, ref1, results, sub_type, target_type, targets;
            //...................................................................................................
...
//.....................................................................................................
    ...
    _compile_declaration_object(type, declaration) {
      ...
      if ((R.test == null) && this._looks_like_an_object_declaration(declaration)) {
        R.test = 'object';
      }
      //.......................................................................................................
      switch (true) {
    ...
    _get_evaluate(declaration) {
      ...
      //.......................................................................................................
      return nameit(method_name, function(x) {
        var R, field_name, sub_test;
        me._validate_arity_for_method(method_name, 1, arguments.length);
        R = {};
        R[test.name] = test.call(me, x);
        for (field_name in sub_tests) {
          sub_test = sub_tests[field_name];
          debug('^2342^', sub_test.name, me.evaluate[sub_test.name.replace(/^isa\./, '')], x); // = sub_test.call me, x[ field_name ]
        }
        return R;
      });
    }
  ...
  //===========================================================================================================
  walk_transitive_field_names = function*(fq_name) {
    var i, len, part, parts;
    types.validate.text(fq_name);
    parts = fq_name.split('.');
