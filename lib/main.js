(function() {
  ...
  Intertype = (function() {
    ...
    class Intertype extends H.Intertype_abc {
      ...
      //---------------------------------------------------------------------------------------------------------
      _inner_isa(...hedges) {
        var R, advance, element, error, hedge, hedge_idx, is_terminal, last_hedge_idx, ref, result, tail_hedges, type_dsc, x;
        ref = hedges, [...hedges] = ref, [x] = splice.call(hedges, -1);
        ...
        while (true) {
          ...
          switch (hedge) {
            //...................................................................................................
            case 'of':
              this.state.hedgeresults.push(['▲ii1', this.state.isa_depth, 'of', x, true]);
            ...
            //...................................................................................................
            case 'or':
              this.state.hedgeresults.push(['▲ii2', this.state.isa_depth, 'or', x, true]);
              R = true;
              continue;
          }
          //.....................................................................................................
