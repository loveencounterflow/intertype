    ...
    class _Intertype {
      ...
      _declare(...declarations) {
        ...
        for (i = 0, len = declarations.length; i < len; i++) {
          ...
          for (type in collection) {
            ...
            ((type, test) => {
              var declaration, j, len1, ref1, results, sub_type, target, target_type, targets;
              //...................................................................................................
              ...
              for (j = 0, len1 = targets.length; j < len1; j++) {
                ...
                set(target, sub_type, function() {
                  return debug('^5345^', type);
                });
                results.push(debug('^5345^', target));
              }
              return results;
            })(type, test);
          }
      ...
      _resolve_dotted_type(type) {
        ...
        if ((sub_types = type.split('.')).length > 1) {
          ...
          targets = [this.isa[target_type], this.isa.optional[target_type], this.validate[target_type], this.validate.optional[target_type]];
        }
      ...
      _compile_declaration_object(type, test) {
        var R, declaration, template;
        template = {
          override: false
        };
        if (this.constructor === _Intertype) {
          if (default_declarations.function(test)) {
