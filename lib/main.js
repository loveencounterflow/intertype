(function() {
  ...
  this.Intertype = (function() {
    class Intertype extends Intertype_abc {
      //---------------------------------------------------------------------------------------------------------
      constructor(cfg) {
        var base_proxy_cfg, count, group, ref, sub_proxy_cfg;
        super();
        //.......................................................................................................
        ...
        base_proxy_cfg = {
          get: (target, key) => {
            ...
            this._hedgebuffer.length = 0;
            this._hedgebuffer.push('_isa');
            this._hedgebuffer.push(key);
        ...
        sub_proxy_cfg = {
          get: (target, key) => {
            ...
            f = function(x) {
              var method_name;
              debug('^878-3^', this._hedgebuffer);
              method_name = this._hedgebuffer.shift();
              return this[method_name](...this._hedgebuffer, x);
            };
            f = {
              [`${key}`]: f
            }[key];
        ...
        GUY.props.hide(this, '_hedgebuffer', []);
        debug('^878-4^', this._hedgebuffer);
