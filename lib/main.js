(function() {
  ...
  this.Intertype = (function() {
    class Intertype extends Intertype_abc {
      ...
      //---------------------------------------------------------------------------------------------------------
      _isa(...hedges) {
        var R, advance, element, hedge, hedge_idx, is_terminal, last_hedge_idx, ref, result, tail_hedges, type_cfg, x;
        ...
        while (true) {
          ...
          //.....................................................................................................
          throw new E.Intertype_internal_error('^intertype.isa@4^', `unexpected return value from hedgemethod for hedge ${rpr(hedge)}: ${rpr(R)}`);
        }
        //.......................................................................................................
        return R;
      }
