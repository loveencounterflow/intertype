(function() {
  'use strict';
  var CND, Multimix, alert, assign, badge, cast, check, debug, declarations, flatten, get_rprs_of_tprs, help, info, isa, isa_list_of, isa_object_of, isa_optional, jk_equals, jr, js_type_of, rpr, sad, urge, validate, validate_list_of, validate_optional, warn, whisper, xrpr;
