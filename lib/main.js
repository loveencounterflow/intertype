    ...
    class Intertype extends Intertype_abc {
          ...
          return (cfg, test = null) => {
            ...
            if (test != null) {
              if ((cfg != null ? cfg.test : void 0) != null) {
                throw new E.Intertype_ETEMPTBD('^intertype.declare@2^', "cannot give both positional and named argument test");
              }
              cfg = {...cfg, test};
            }
        ...
        return {
          get: (target, key) => {
            ...
            if ((key === 'of') && (!this._collections.has(target.name))) {
              throw new E.Intertype_ETEMPTBD('^intertype.sub_proxy@2^', `expected type before \`of\` to be a collection, got ${rpr(target.name)}`);
            }
            //...................................................................................................
            f = {
              [`${key}`]: function(x) {
      ...
      _validate_hedgerow(hedgerow) {
        ...
        if (((ref = hedgerow[0]) === 'of' || ref === 'or') || ((ref1 = hedgerow[hedgerow.length - 1]) === 'of' || ref1 === 'or')) {
          ...
          throw new E.Intertype_ETEMPTBD('^intertype.validate_hedgerow@2^', `hedgerow cannot begin or end with \`of\` or \`or\`, must be surrounded by hedges, got ${xr}`);
        }
        return null;
      }
      ...
      _isa(...hedges) {
        ...
        while (true) {
          ...
          switch (hedge) {
            ...
            case 'of':
              ...
              try {
                ...
                throw new E.Intertype_ETEMPTBD('^intertype.isa@3^', `\`of\` must be preceded by collection name, got ${rpr(hedges[hedge_idx - 1])}`);
              }
              return true;
            //...................................................................................................
            case 'or':
          ...
          //.....................................................................................................
          throw new E.Intertype_internal_error('^intertype.isa@5^', `unexpected return value from hedgemethod for hedge ${rpr(hedge)}: ${rpr(R)}`);
        }
        //.......................................................................................................
        return R;
      }
      ...
      _create(type, cfg) {
        ...
        if ((create = GUY.props.get(type_cfg, 'create', null)) === null) {
          if ((R = GUY.props.get(type_cfg, 'default', H.signals.nothing)) === H.signals.nothing) {
            throw new E.Intertype_ETEMPTBD('^intertype.create@8^', `type ${rpr(type)} does not have a \`default\` value or a \`create()\` method`);
          }
        } else {
