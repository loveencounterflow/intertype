...
(function() {
  'use strict';
  var CND, Multimix, alert, assign, badge, cast, debug, declarations, flatten, get_rprs_of_tprs, help, info, isa, isa_list_of, jr, js_type_of, rpr, urge, validate, warn, whisper, xrpr;
  ...
  this.Intertype = (function() {
    class Intertype extends Multimix {
      ...
      constructor(target = null) {
        ...
        this.isa.xlist_of = Multimix.get_keymethod_proxy(this, isa_list_of);
