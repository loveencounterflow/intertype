(function() {
  'use strict';
  var CND, Defaults, E, Empty, GUY, H, ITYP, Intertype_abc, Isa, Isa_empty, Isa_list_of, Isa_nonempty, Isa_optional, List_of, Nonempty, Validate, Validate_empty, Validate_list_of, Validate_nonempty, Validate_optional, alert, badge, debug, echo, empty, error, help, info, js_type_of, length_of, list_of, log, njs_path, nonempty, praise, ref, rpr, urge, warn, whisper, x,
    splice = [].splice,
      ...
      * _walk_hedgepaths(type_cfg, hedge_idx = 0, current_path = []) {
      ...
      _declare_hedgepath({method, test, type, type_cfg, name, hedgepath}) {
        ...
        if (!parent.has(type)) {
          //.....................................................................................................
          test = (x) => {
            var R, hedgemethod, i, len, term;
            for (i = 0, len = hedgemethods.length; i < len; i++) {
              [term, hedgemethod] = hedgemethods[i];
