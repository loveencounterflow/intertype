(function() {
  'use strict';
  var CND, Defaults, Empty, GUY, Intertype_abc, Isa, Isa_empty, Isa_list_of, Isa_nonempty, Isa_optional, List_of, Nonempty, Validate, Validate_empty, Validate_list_of, Validate_nonempty, Validate_optional, _types, alert, badge, debug, echo, empty, error, help, info, js_type_of, length_of, list_of, log, njs_path, nonempty, praise, ref, rpr, test, urge, warn, whisper, x,
  ...
  ref = this.Intertype = (function() {
    class Intertype extends Intertype_abc {
      ...
      declare(type, descriptor) {
        ...
        test = descriptor.test.bind(this);
        this._types[type] = {...descriptor, test};
        return null;
      }

      isa(...hedges) {
        var name, ref1, ref2, type, x;
        boundMethodCheck(this, ref);
