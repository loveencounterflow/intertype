(function() {
  ...
  */
  ...
  this.declare_types = function() {
    ...
    this./* TAINT make sure no non-numbers slip through */declare('float', {
      tests: (x) => {
        return Number.isFinite(x);
      },
      casts: {
    ...
    this.specs.number = this.specs.float;
    //.........................................................................................................
    ...
    this./* TAINT test finite or safeinteger, then use `%` */declare('odd', (x) => {
      return !this.isa.even(x);
    });
    this./* TAINT test directly, faster */declare('count', function(x) {
