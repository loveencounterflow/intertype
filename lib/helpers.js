...
/* Mark Miller Device */      return 'wrapper';
  ...
  this.types.declare('intertype_get_state_report_cfg', {
    tests: {
      ...
      "x.mode in [ 'all', 'failing', ]": function(x) {
        var ref1;
        return (ref1 = x.mode) === 'all' || ref1 === 'failing';
      }
    }
  });
  ...
  this.get_state_report = function(hub, cfg) {
    var R, TTY, first_hidx, hedge, hidx, i, last_hidx, level, push_error_row, push_value_row, r, ref, ref1, ref2, truth, value, verb_field, widths;
