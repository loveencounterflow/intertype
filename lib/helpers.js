(function() {
  'use strict';
  var E, GUY, Intertype_abc, blue, debug, green, grey, help, info, misfit, notavalue, red, rpr, rvr, to_width, urge, warn, yellow,
    indexOf = [].indexOf;
...
/* Mark Miller Device */      return 'wrapper';
  ...
  this.get_state_report = function(hub) {
    var R, dent, error, error_r, hedge, hedgeresults, hedgerow, hedges, i, len, level, r, ref, result, truth, value, verb, verb_field, widths, x, xr;
