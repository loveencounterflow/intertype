...
/* Mark Miller Device */      return 'wrapper';
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.types.declare('Type_cfg_constructor_cfg_NG', {
    tests: {
      "@isa.object x": function(x) {
        return this.isa.object(x);
      },
      ...
      /* TAINT might want to check for existence of `$`-prefixed keys in case of `( not x.test? )` */
      /* TAINT should validate values of `$`-prefixed keys are either function or non-empty strings */
      "@isa_optional.function x.test": function(x) {
        return this.isa_optional.function(x.test);
      },
      "@isa optional list.of.function x.tests": function(x) {
        if (!this.isa.list(x.tests)) {
          return true;
        }
        return this.isa_list_of.function(x.tests);
      },
      "exactly one of x.test, x.tests must be given": function(x) {
        return ((x.test != null) && (x.tests == null)) || ((x.test == null) && (x.tests != null));
      }
    }
  });

  //...........................................................................................................
  this.defaults.Type_cfg_constructor_cfg_NG = {
    name: null,
    test: null,
    tests: null,
    collection: false,
