(function() {
  'use strict';
  var E, GUY, Intertype_abc, blue, debug, green, grey, help, info, misfit, notavalue, red, rpr, rvr, steel, to_width, urge, warn, yellow,
    indexOf = [].indexOf;
...
/* Mark Miller Device */      return 'wrapper';
  ...
  this.get_state_report = function(hub) {
    var R, TTY, error, hedge, hedgeresults, hedgerow, hedges, i, len, level, push_error_row, push_value_row, r, ref, ref1, result, truth, value, verb, verb_field, widths, x;
    ...
    verb_field = blue(rvr(to_width(verb, widths.verb, {
      align: 'center'
    })));
    //.........................................................................................................
...
//.........................................................................................................
    ...
    push_error_row((ref1 = hub.state.error) != null ? ref1 : null);
    //.........................................................................................................
    return R.join('');
  };
