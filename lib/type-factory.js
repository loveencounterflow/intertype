(function() {
  ...
  Type_factory = class Type_factory extends H.Intertype_abc {
    ...
    _normalize_type_cfg(...P) {
      ...
      if (dsc.isa != null) {
        ...
        dsc.isa = H.nameit(`${dsc.name}:${name_of_isa}`, (() => {
          ...
          return (x) => {
            var R, hedgeresult;
            this.hub.state.hedgeresults.push(hedgeresult = ['▲nt1', this.hub.state.isa_depth, dsc.name, x]);
            R = (() => {
              var error;
              try {
                return f(x);
    ...
    _create_test_walker(dsc) {
      ...
      //.......................................................................................................
      return function(x) {
        var R, _, f, hedgeresult, ref;
        //.....................................................................................................
        hub.state.hedgeresults.push(hedgeresult = ['▲tw1', hub.state.isa_depth, this.isa.name, x]);
        hub.state.isa_depth++;
        R = this.isa(x);
        hub.state.isa_depth--;
        hedgeresult.push(R);
