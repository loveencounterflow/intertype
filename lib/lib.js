    ...
    _cast_declaration(typespace, typename, declaration) {
      ...
      switch (true) {
        ...
        case $isa.function(declaration):
          ...
          nameit(typename, declaration.isa);
          break;
        case $isa.nonempty_text(declaration):
          declaration = ((typeref) => {
            return {
              isa: (function(x, t) {
      ...
      switch (true) {
        case (declaration.create == null) && (declaration.fields == null):
          ...
          declaration.create = function() {
            throw new Error(`Ω__14 MEH-create-1 unable to create value of type ${rpr(typename)}`);
          };
      }
      return declaration;
    }
