    ...
    _compile_declaration_create(typespace, typename, declaration) {
      ...
      if (declaration.template != null) {
        ...
        declaration.create = function(P, t) {
          ...
          //   throw new Error "Ω__18 create method for #{typename} does not accept arguments, got #{P.length} (see condition cD in README)"
          R = {};
          // overrides
          debug('Ω__17', P);
          ref = this.fields;
      ...
      declaration.create = function(P, t) {
        ...
        if (P.length !== 0) {
          throw new Error(`Ω__19 create method for ${typename} does not accept arguments, got ${P.length} (see condition cF in README)`);
        }
        R = {};
        ref = this.fields;
        for (field_name in ref) {
