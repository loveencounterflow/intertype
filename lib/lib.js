(function() {
  ...
  Type = class Type {
    ...
    constructor(typespace, typename, declaration) {
      ...
      //.......................................................................................................
      declaration = this._cast_declaration(typespace, typename, declaration);
      declaration = this._compile_isa(typespace, typename, declaration);
      ...
      switch (true) {
        ...
        case $isa.nonempty_text(declaration.isa):
          ...
          declaration.isa = ((typeref) => {
            return function(x, t) {
              return t.isa(typespace[typeref], x);
            };
          })(declaration.isa);
          break;
        case $isa.function(declaration.isa):
          null;
          break;
        case declaration.isa == null:
          ...
          break;
        default:
          throw new /* TAINT should we be using `std.pod` here instead? */Error(`Ω___8 expected \`declaration.isa\` to be a function, a type or a typeref, got a ${$type_of(declaration.isa)}`);
      }
