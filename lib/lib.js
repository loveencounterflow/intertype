(function() {
  ...
  Type = class Type {
    ...
    constructor(typespace, typename, declaration) {
      ...
      this._compile_declaration_create(typespace, typename, declaration);
//.......................................................................................................
    ...
    _compile_declaration_create(typespace, typename, declaration) {
      ...
      if (typename === 'int_create_fn') {
        debug('Ω__12', 'CREATE', typename);
      }
      //.......................................................................................................
      /* condition cC */
      ...
      if (typename === 'int_create_fn') {
        debug('Ω__14', 'CREATE', typename);
      }
      //.......................................................................................................
      if (declaration.create != null) {
        if (typename === 'int_create_fn') {
          debug('Ω__15', 'CREATE', typename);
        }
        /* condition cB */
      ...
      if (!has_fields) {
        if (typename === 'int_create_fn') {
          debug('Ω__17', 'CREATE', typename);
        }
        /* condition cI */
        if (declaration.template == null) {
          declaration.create = function(P, t) {
            throw new Error(`Ω__18 type ${rpr(typename)} does not support value creation (see condition cI in README)`);
          };
          return null;
        }
        /* condition cG */
        ...
        declaration.create = ((seed_value) => {
          return function(P, t) {
            if (P.length !== 0) {
              throw new Error(`Ω__19 create method for ${typename} does not accept arguments, got ${P.length} (see condition cH in README)`);
            }
            return seed_value;
          };
        })(declaration.template);
      ...
      if (typename === 'int_create_fn') {
        //.......................................................................................................
        debug('Ω__20', 'CREATE', typename);
      }
      template_isa_pod = $isa.pod(declaration.template);
      if (declaration.template != null) {
        if (typename === 'int_create_fn') {
          debug('Ω__21', 'CREATE', typename);
        }
        /* condition cE */
        if (!template_isa_pod) {
          throw new Error("Ω__22 (see condition cE in README)");
        }
        /* condition cD */
        ...
        declaration.create = function(P, t) {
          ...
          if (P.length !== 0) {
            throw new Error(`Ω__23 create method for ${typename} does not accept arguments, got ${P.length} (see condition cD in README)`);
          }
          R = {};
          ref = this.fields;
          for (field_name in ref) {
      ...
      if (typename === 'int_create_fn') {
        //.......................................................................................................
        /* condition cF */
        debug('Ω__24', 'CREATE', typename);
      }
      declaration.create = function(P, t) {
        var R, field_name, ref, type;
        if (P.length !== 0) {
          throw new Error(`Ω__25 create method for ${typename} does not accept arguments, got ${P.length} (see condition cF in README)`);
        }
        R = {};
        ref = this.fields;
        for (field_name in ref) {
