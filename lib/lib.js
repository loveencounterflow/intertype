    ...
    _compile_declaration_create(typespace, typename, declaration) {
      ...
      if (!has_fields) {
        ...
        if (declaration.template == null) {
          declaration.create = function(...P) {
            var ref, t;
            ref = P, [...P] = ref, [t] = splice.call(P, -1);
      ...
      if (declaration.template != null) {
        ...
        declaration.create = function(...P) {
          var R, field_name, ref, ref1, seed, t, type;
          ref = P, [...P] = ref, [t] = splice.call(P, -1);
          if (P.length !== 0) {
      ...
      if (typename === 'int_no_create') {
        //.......................................................................................................
        /* condition cF */
        debug('Ω__23', 'CREATE', typename);
      }
      declaration.create = function(...P) {
        var R, field_name, ref, ref1, t, type;
        ref = P, [...P] = ref, [t] = splice.call(P, -1);
        if (P.length !== 0) {
