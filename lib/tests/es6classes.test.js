(function() {
  ...
  this["es6classes type detection devices (prototype)"] = function(T, done) {
    var FooObject, Generator, MyArrayClass, MyBareClass, MyObjectClass, OtherConstructor, SomeConstructor, color, column_width, dddx_v2, dddx_v2_type, domenic_denicola_device, h, headers, i, idx, intertype, isa, j, last_idx, lc_result, len, len1, mark_miller_device, matcher, probe, probes_and_matchers, raw_result, raw_results, results, string_tag, type_of, validate;
    intertype = new Intertype();
