(function() {
  'use strict';
  var CND, Generator, INTERTYPE, Intertype, alert, assign, badge, debug, demo_test_for_generator, echo, flatten, get_probes_and_matchers, help, info, js_type_of, log, njs_path, praise, rpr, test, type_of_v3, type_of_v4, urge, warn, whisper;
  ...
  type_of_v3 = function(...xP) {
    ...
    if (xP.length !== 1) {
      ...
      throw new Error(`^7746^ expected 1 argumnt got ${arity}`);
    }
...
/* Mark Miller Device */      return 'wrapper';
  ...
  this["es6classes type detection devices (prototype)"] = function(T, done) {
    var color, column_width, domenic_denicola_device, h, headers, i, idx, intertype, isa, j, last_idx, lc_result, len, len1, mark_miller_device, matcher, probe, raw_result, raw_results, ref, results, string_tag, type_of_v4_type, validate;
    intertype = new Intertype();
  ...
  if (module === require.main) {
    (() => {
      ...
      return urge(Object.getOwnPropertyNames((function() {})));
    })();
  }
