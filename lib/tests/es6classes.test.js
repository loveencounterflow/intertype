(function() {
  'use strict';
  var CND, INTERTYPE, Intertype, alert, assign, badge, debug, demo_test_for_generator, echo, flatten, get_probes_and_matchers, help, info, js_type_of, log, njs_path, praise, rpr, test, type_of_v3, urge, warn, whisper;
