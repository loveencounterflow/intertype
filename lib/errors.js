(function() {
  ...
  this.Intertype_basetype_override_forbidden = class Intertype_basetype_override_forbidden extends this.Intertype_error {
    constructor(ref, type) {
      super(ref, `${rpr(type)} is a built-in base type and may not be overridden`);
    }
  ...
  this.Intertype_declaration_override_forbidden = class Intertype_declaration_override_forbidden extends this.Intertype_error {
    constructor(ref, type) {
      super(ref, `type ${rpr(type)} has already been declared and may not be overridden unless override is set to true`);
    }
